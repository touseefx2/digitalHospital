...
import {  View,Image,ToastAndroid,TouchableOpacity,StyleSheet,Keyboard} from "react-native";
...
export default class PatientSignupScreen extends Component {
...
validate= ()=>
{
 if(this.state.name == "" || this.state.psd== "" || this.state.eml == "" || this.state.phn == "" || this.state.gndr == "" )
   return false;
 else
   return true;
}
 ...
 getstoreinput   = async () => {
  try {
    var value =JSON.parse(await AsyncStorage.getItem('patientinputlist'))
    if(value != null)
    {
      console.log(value);
...
<View style={{justifyContent:"center",alignItems:"center"}}>
        <Image  source={require("../../assets/ptntlogo.jpg")} style={{width:130, height:130,borderRadius:65}}   />
        </View>
