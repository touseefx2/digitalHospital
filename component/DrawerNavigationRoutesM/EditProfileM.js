...
class EditProfileM extends Component {
  ...
  <Form style={{margin:15,padding:15}}>
           ...
           <Item style={{borderColor:"black"}} floatingLabel>
            ...
            <Item style={{borderColor:"black"}} floatingLabel>
              ...
              <Input  value={ptcl}  onChangeText={(txt)=>this.setState({ptcl:txt})} 
              multiline={true}
              numberOfLines={1}
              />
            </Item>
...
export default connect(mapStateToProps)(EditProfileM); 