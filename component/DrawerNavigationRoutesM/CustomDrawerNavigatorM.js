...
const  mapStateToProps = (state) => 
{
 ...
 function CustomDrawerNavigatorM (props) { 
...
<TouchableOpacity onPress={()=>props.navigation.navigate("UserProfileM")} style={{margin:5,flexDirection:"row",alignItems:"center"}}>
...
export default connect(mapStateToProps)(CustomDrawerNavigatorM);