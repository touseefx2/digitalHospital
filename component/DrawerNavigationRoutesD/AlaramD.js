...
import { TextInput } from 'react-native-paper';
 ...
 export default class AlaramD extends React.Component  {
  constructor(props) {
    super(props);
    this.state =
    {
...
renderMessageAboutAlarm()
{
  ...
  >
    <DialogContent>
    <TextInput 
    style={{fontSize:18,padding:3,width:180,height:100,marginTop:10}}
...
return(  
    ...
    <Text style={{color:"#095c3f",fontSize:19,alignSelf:"center",textDecorationLine:"underline"}}>REMINDER LIST</Text>
      ...
      <Text style={{color:"#307ecc",fontSize:18,alignSelf:"center",fontWeight:"bold"}}>CREATE REMINDER</Text>  
      </TouchableOpacity>
      </View>
