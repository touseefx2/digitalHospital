 ...
 export default class  ViewProfile extends React.Component  {
  ...
  renderProfile()
  {
    ...
    if(d!= null){
        ...
        <TouchableOpacity onPress={()=>{this.props.navigation.navigate("ViewReport",{receiverid:ptid})}}   style={{marginTop:7,alignSelf:"flex-end",marginRight:10}} >
          <Text style={{color:"yellow",backgroundColor:"#307ecc",borderRadius:7,textTransform: 'capitalize',fontSize:14,padding:5}}>Reports</Text>
        </TouchableOpacity >
