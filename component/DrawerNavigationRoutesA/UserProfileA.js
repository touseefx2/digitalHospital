...
class UserProfileA extends Component {
...
//fo clck camera btn dialog option
     ...
     imagefolder:`Photos/Assistant/profilePictures/${this.props.myuser.uid}/`,
 }
}
...
<Button mode="contained" style={{width:80,backgroundColor:"#307ecc",margin:10,borderWidth:1,borderRadius:20,elevation:7}} onPress={()=>{this.props.navigation.navigate("EditProfileA")}} >
  ...
  <Form style={{margin:15,padding:15}}>
            ...
            <Item floatingLabel style={{borderColor:"black"}}>
              <Label>Assistant by</Label>
              <Input  value={this.props.myuser.refdoctoremail}
              multiline={true}
              numberOfLines={1}
              underlineColorAndroid='transparent'  
             editable={false} />
            ...
            <Item floatingLabel style={{borderColor:"black"}}>
              <Label>Gender</Label>
              <Input style={{textTransform:"capitalize"}} editable={false} value={this.props.myuser.gender} />
            </Item>
...
export default connect(mapStateToProps)(UserProfileA);