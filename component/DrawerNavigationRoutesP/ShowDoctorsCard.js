...
<TouchableOpacity 
  onPress={()=>{props.navigate("HomeScreen",{d:props.d,cuid:props.cuid})}}
  style={{width:165}}>
  ...
  {props.d.username.length > 15 ?
         (
         <Text  style={{fontWeight:"bold",fontSize:14,textTransform:"capitalize"}}>Dr.{`${props.d.username.substring(0, 15)}..`}</Text>
         ) :
         <Text style={{fontWeight:"bold",fontSize:14,textTransform:"capitalize"}}>Dr.{props.d.username}</Text>
  }
