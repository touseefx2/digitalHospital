...
class UserProfileP extends Component {
...
//fo clck camera btn dialog option
     ...
     imagefolder:`Photos/Patients/profilePictures/${this.props.myuser.uid}/`,
 }
}
...
<Button mode="contained" style={{width:80,backgroundColor:"#307ecc",margin:10,borderWidth:1,borderRadius:20,elevation:7}} onPress={()=>{this.props.navigation.navigate("EditProfileP")}} >
...
export default connect(mapStateToProps)(UserProfileP);